...
my_key <- "hda5BVfOWGIqGMzzozIZlPgYWneHQSE8iOkPLL5H"
```
...
safe_parse <- safely(
                     function(country, key) {
                       ...
                       # We were getting an error, so we looked on the internet for this line of code and the parameters
                       # Source:ChatGPT
